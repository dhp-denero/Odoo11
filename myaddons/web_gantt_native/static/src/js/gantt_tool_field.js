...
"use strict";
        ...
        var generate_flat_gantt = function(value) {
            ...
            if (value.is_group) {
                ...
                rows_to_gantt.push({
                    ...
                    bar_start_info: value.bar_start_info,
                    bar_end_info: value.bar_end_info,
    ...
    function groupRows (tasks, group_bys, self_parent) {
       ...
       //prevent more that 1 group by
        ...
        //
        // var sortByGanttSeq = true;
        //
        // //Sort from kanban if group by second_seq_group = stage_id
        // if (group_bys.length === 1 && group_bys[0] === gantt_attrs["second_seq_link_field"]){
        //
        //     sortByGanttSeq = false
        //
        //
        //
        // }
        ...
        var generate_task_info = function(task, plevel) {
            ...
            if (task.__is_group) {
                ...
                var bar_start_info = task[model_fields_dict["bar_start_info"]];
                var bar_end_info = task[model_fields_dict["bar_end_info"]];
                ...
                return {
                    ...
                    bar_start_info: bar_start_info,
                    bar_end_info: bar_end_info,
